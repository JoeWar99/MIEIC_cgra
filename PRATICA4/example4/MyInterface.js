...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'checkbox').name('Display Quad');
        this.gui.add(this.scene, 'checkbox_texture').name('Display Texture');
        this.gui.add(this.scene, 'Vis_Tangram').name('Vis_tangram');
        this.gui.add(this.scene, 'Vis_Cubo').name('Vis_Cubo');
