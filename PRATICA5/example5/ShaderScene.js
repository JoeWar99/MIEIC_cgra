class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.texture_water =new CGFtexture(this, "textures/waterTex.jpg");
		this.texture_water_map = new CGFtexture(this, "textures/waterMap.jpg");
		...
		this.testShaders[10].setUniformsValues({ uSampler2: 2 });
	...
	display() {
		...
		if(this.selectedExampleShader == 10){
			this.appearance.setTexture(this.texture_water);
		}
		else{
			this.appearance.setTexture(this.texture);
		}
